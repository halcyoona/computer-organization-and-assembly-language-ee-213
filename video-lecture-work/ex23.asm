;swap and bublesort subroutine with parameters and local variables
...
bubblesort:	
			...
			sub sp, 2				;making space for local variable i.e swapFlag
			push ax
			push bx
			push cx
			push si
...
mainloop:	mov si, 0				;initialize array index to zero
			mov word [bp-2], 0			;reset  swap flag to no swap
